	...
	return (
		<div className={ s.form }>
			<form onSubmit={handleSubmit(onSubmit)}>
				<p className={ s.heading }>Forgot your password?</p>
				...
				<div className={ s.btn }>
					<button className={ s.button1 } type={'submit'}>Send Instructions</button>
				</div>
				<p className={s.description}>Did you remember your password?</p>
			</form>
			<button className={ s.button3 } onClick={signInRedirect}>Try logging in</button>
		</div>
	);
};